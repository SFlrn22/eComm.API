...
namespace eComm.API.Controllers
{
    ...
    public class RecommenderController : ControllerBase
    {
        ...
        {
            List<TopProductsDTO> result = await _recommenderService.GetRecommendedItems(id, "item");
            return Ok(result);
        }
        ...
        {
            List<TopProductsDTO> result = await _recommenderService.GetRecommendedItems(id, "content");
            return Ok(result);
        }
    }
}
